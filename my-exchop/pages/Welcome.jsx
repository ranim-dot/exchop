...
const Welcome = () => {
  return (
    <div className='relative bg-gradient-to-br from-slate-600 to-slate-700 
      ...
      <div className="absolute animate-blob bg-gradient-to-br from-slate-600 to-slate-800  blur-sm w-60 h-60 rounded-full cercle-left"></div>
      ...
      <p className='text-slate-300 drop-shadow-sm tracking-in-expand-fwd-top text-center font-semibold pt-3 sm:text-truncate  lg:text-lg sm:text-md'>
